...
HEADING_MANAGED_DOC_SPECS = {
    ...
    "volume_plot_progress": {
        ...
        "section_policy": [
            "一级标题固定为《卷级剧情进程》。",
            "正文用二级标题管理当前卷内不同类型的推进信息，不要写成 subplot_id 或 rhythm_track 这类字段表。",
            "如果某本书当前卷更适合按“试炼线”“宗门线”“副本线”“感情线”来管理，就按真实内容设置二级标题。",
            "已有卷内二级标题尽量沿用，新增二级标题只在本卷确实出现新的推进维度时才添加。",
        ],
        "update_rules": [
            "只更新受当前章节影响的卷内推进内容与本章卷内推进。",
            "未变化的卷内推进必须原样保留，不得重写整卷进程总结。",
    ...
    "world_model": {
        ...
        "section_policy": [
            "一级标题固定为《世界模型》。",
            "正文用二级标题管理世界知识，不要写成 rule_id、faction_id 一类的字段表。",
            "不同小说的世界知识类型差异很大；如果出现炼丹体系、神兵体系、血脉体系、职业体系、地图板块、历史断代等特有内容，应按实际需要新增二级标题。",
            "新增世界专题时，优先保持名称清晰、长期可复用，后续继续在同一二级标题下增量更新。",
        ],
        "update_rules": [
            "只更新当前章节真正新增或修正的世界知识，以及本章新增或修正认知。",
            "未变化的世界知识必须原样保留，不得为统一措辞而重写整份世界模型。",
            "如果当前章节没有带来新的世界知识或修正规则，可以完全不更新此文档。",
        ],
    },
    "world_state": {
        "template": [
